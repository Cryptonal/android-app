...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        opts.position(new LatLng(40, 100));
    ...
    public void onMapReady1(GoogleMap googleMap) {
        ...
        opts1.position(new LatLng(80, 200));
        googleMap.addMarker(opts1);
    ...
    public void onMapReady2(GoogleMap googleMap) {
        ...
        opts2.position(new LatLng(-40, 150));
        googleMap.addMarker(opts2);
    ...
    public void onMapReady3(GoogleMap googleMap) {
        ...
        opts3.position(new LatLng(600,50));
        googleMap.addMarker(opts3);
